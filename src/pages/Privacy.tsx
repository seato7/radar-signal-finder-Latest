...
import { Menu, ArrowRight, FileText, HelpCircle, CreditCard } from "lucide-react";
import {
  PRIVACY_VERSION,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="lg:grid lg:grid-cols-[16rem_1fr] lg:gap-12">
            ...
            <main className="max-w-4xl">
              <GlassCard className="p-6 sm:p-10 mb-10">
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-slate-500">
                  ...
                  <span>Effective Date: {PRIVACY_EFFECTIVE_DATE}</span>
                </div>
              </GlassCard>
              ...
              <p className="text-center text-xs uppercase tracking-widest text-slate-500 mb-8">
                End of Privacy Policy v{PRIVACY_VERSION}
              </p>
