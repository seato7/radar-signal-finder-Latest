                  ...
                  {[
                    {
                      step: "01",
                      name: "Asset Radar",
                      desc: "Browse all 26,000+ scored assets ranked by our algorithmic scoring engine. Filter by sector, asset class, or score band to find opportunities that match your strategy.",
                    },
                    {
                      step: "02",
                      name: "Active Signals",
