...
const dataSources: DataSource[] = [
  ...
  { id: '13', name: 'SEC 13F Holdings', function: 'ingest-sec-13f-edgar', frequency: 'Daily 6 AM', category: 'daily' },
  ...
  { id: '18', name: 'Search Trends', function: 'ingest-search-trends', frequency: 'Daily 6 AM', category: 'daily' },
