...
const Bots = () => {
  ...
  const handleJoinWaitlist = () => {
    ...
    toast({
      ...
      description: "We'll notify you when Trading Bots launches.",
    });
  };
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Trading Bots"
        description="Automated trading strategies powered by InsiderPulse signals"
      />
          ...
          <CardContent className="flex flex-col items-center text-center pt-10 pb-10 px-8 gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed max-w-sm">
                We're building AI-powered trading bots that automatically execute trades
                based on InsiderPulse signals. Premium users will get first access when we launch.
              </p>
            </div>
            ...
            {!submitted ? (
              ...
              <div className="w-full rounded-lg bg-success/10 border border-success/30 p-4">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  We'll email you as soon as Trading Bots is ready.
                </p>
              </div>
            )}
          </CardContent>
