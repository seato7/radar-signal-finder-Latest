...
const TOPIC_TICKER_MAP: Record<string, string[]> = {
  // ENERGY & OIL
  'oil': ['XOM','CVX','BP','COP','SLB','HAL','OXY','USO','BNO','VLO','PSX','MPC','MTDR','CIVI','PDCE','REI','SWN','CRGY'],
  'crude': ['XOM','CVX','BP','COP','SLB','USO','BNO'],
  'crude oil': ['XOM','CVX','BP','COP','SLB','USO'],
  'opec': ['XOM','CVX','BP','COP','SLB','HAL','USO'],
  'natural gas': ['LNG','AR','EQT','SWN','UNG','RRC','CNX','CTRA','GPOR'],
  ...
  'uranium': ['CCJ','UEC','NNE','SMR','BWXT','DNN','URG','EU','UUUU','LTBR','NXE'],
  'nuclear': ['CCJ','UEC','NNE','SMR','BWXT','CEG','VST','OKLO','LTBR'],
  ...
  // GEOPOLITICAL & WAR
  'war': ['LMT','RTX','NOC','GD','BA','HII','KTOS','CACI','SAIC','PLTR','AXON','AVAV','BWXT','DRS'],
  'conflict': ['LMT','RTX','NOC','GD','BA','HII'],
  'military': ['LMT','RTX','NOC','GD','BA','HII','KTOS'],
  'defense': ['LMT','RTX','NOC','GD','BA','HII','KTOS','CACI','PLTR','AXON','AVAV','BWXT','DRS'],
  'weapon': ['LMT','RTX','NOC','GD','BA','HII'],
  'missile': ['LMT','RTX','NOC','GD','BA','KTOS','AVAV','BWXT','DRS'],
  'bomb': ['LMT','RTX','NOC','GD','BA'],
  'drone': ['LMT','RTX','KTOS','AVAV','JOBY','ACHR','ARCHER'],
  ...
  // HEALTHCARE & PHARMA
  'fda': ['PFE','JNJ','MRNA','BNTX','ABBV','BMY','LLY','REGN','AMGN','RCKT','KRYS','KYMR','FOLD','IMVT','ACAD'],
  'drug approval': ['PFE','JNJ','MRNA','BNTX','ABBV','BMY','LLY','REGN','RCKT','KRYS','KYMR','FOLD','IMVT'],
  ...
  'obesity': ['LLY','NVO','AMGN','VKTX','RVNC','WTMA','GPCR','RDUS'],
  ...
  'biotech': ['XBI','IBB','MRNA','BNTX','REGN','VRTX','ALNY','RCKT','KRYS','KYMR','FOLD','IMVT','ACAD'],
  ...
  // TECHNOLOGY
  'ai': ['NVDA','MSFT','GOOGL','META','AMD','AMZN','TSM','AVGO','PLTR','BBAI','SOUN','SYNTX','GFAI','AMBA'],
  'artificial intelligence': ['NVDA','MSFT','GOOGL','META','AMD','AMZN','TSM','PLTR','BBAI','SOUN','AMBA'],
  ...
  'semiconductor': ['NVDA','AMD','INTC','TSM','AMAT','KLAC','LRCX','ASML','MRVL','WOLF','SITM','FORM','INDI','POWI'],
  'chip': ['NVDA','AMD','INTC','TSM','QCOM','AVGO','MU','ON','MCHP','WOLF','SITM','FORM','INDI','POWI','ACLS'],
  ...
  'cybersecurity': ['CRWD','PANW','ZS','FTNT','OKTA','S','CYBR','TENB','QLYS','VRNT','SAIL','BGCP','RPID'],
  ...
  'cloud': ['AMZN','MSFT','GOOGL','CRM','NOW','SNOW','DDOG','NET','BILL','GTLB','DOCN','FSLY','BAND'],
  'aws': ['AMZN'],
  'azure': ['MSFT'],
  'google cloud': ['GOOGL'],
  'saas': ['CRM','NOW','WDAY','ORCL','SAP','ADBE','VEEV'],
  'data center': ['NVDA','AMD','INTC','EQIX','DLR','AMT','AMZN','MSFT'],
  'electric vehicle': ['TSLA','RIVN','LCID','NIO','LI','XPEV','GM','F','STLA','BLNK','CHPT','EVGO','NKLA','GOEV'],
  'ev': ['TSLA','RIVN','LCID','NIO','LI','GM','F','STLA'],
  'self driving': ['TSLA','GOOGL','GM','INTC'],
  'autonomous vehicle': ['TSLA','GOOGL','GM','INTC'],
  'battery': ['TSLA','ALB','SQM','LTHM','LAC','QS','FREYR','MVST','DCFC','NKLA'],
  'lithium': ['ALB','SQM','LTHM','LAC','TSLA','PLL','AMLI','LTUM'],
  ...
  'bitcoin': ['COIN','MSTR','MARA','RIOT','CLSK','HUT','BTBT','CIFR'],
  ...
  'gold': ['GLD','GDX','NEM','GOLD','AEM','WPM','KGC','AGI','AUMN','GATO','SILV','MAG','EXK','SSRM'],
  ...
  // TRANSPORT & LOGISTICS
  'shipping': ['ZIM','DAC','MATX','SBLK','GOGL','DSX','EGLE','TOPS','DRCT'],
  ...
  'airline': ['DAL','UAL','AAL','LUV','ALK','HA','JBLU','SAVE','SY','SNCY'],
  ...
  'vaping': ['MO','PM','BTI'],
  'cannabis': ['TLRY','CGC','ACB','CRON','CURLF','GTBIF'],
  'gambling': ['DKNG','MGM','WYNN','LVS','PENN','CZR'],
  'casino': ['MGM','WYNN','LVS','PENN','CZR'],
  'sports betting': ['DKNG','PENN','MGM','CZR','RSI','GAMB','BETZ'],
  // CLIMATE & ENVIRONMENT
  ...
  'solar': ['ENPH','FSLR','SEDG','RUN','ARRY','NOVA','SHLS','MAXN','CSIQ'],
  'wind': ['NEE','BEP','CWEN'],
  'clean energy': ['NEE','ENPH','FSLR','PLUG','BE','RUN','CWEN','FCEL','BLDP','AMPE'],
